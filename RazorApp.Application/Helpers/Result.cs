namespace RazorApp.Application.Helpers
{
    public class Result<T>
    {
        ...
        public static Result<T> Failure(int resCode, string message, string errorDetails)
            => new Result<T> { ResultMessage = message, ResultCode = resCode, IsSuccess = false, ErrorDetails = errorDetails };
    }
}
